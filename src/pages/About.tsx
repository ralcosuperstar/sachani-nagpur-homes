...
const About = () => {
  ...
  const achievements = [
    { icon: Building, number: "2M+", label: "Sq.ft. Developed", color: "[#684a47]" },
    { icon: Users, number: "1,500+", label: "Families Served", color: "[#684a47]" },
    { icon: Award, number: "500+", label: "Business Clients", color: "[#684a47]" },
    { icon: CheckCircle, number: "25+", label: "Years Experience", color: "[#684a47]" }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="bg-white p-12 rounded-2xl shadow-lg">
              <div className="flex items-center mb-6">
                <Target className="text-[#684a47] mr-4" size={32} />
            ...
            <div className="bg-white p-12 rounded-2xl shadow-lg">
              <div className="flex items-center mb-6">
                <Eye className="text-[#684a47] mr-4" size={32} />
            ...
            {achievements.map((achievement, index) => (
              <div key={index} className="text-center bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
                <div className="inline-flex items-center justify-center w-16 h-16 bg-orange-100 rounded-full mb-6">
                  <achievement.icon className="text-[#684a47]" size={24} />
                </div>
